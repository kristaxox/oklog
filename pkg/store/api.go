...
func (a *API) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case method == "GET" && path == APIPathDCSLogsQuery:
		a.handleDCSLogsQuery(w, r)
	default:
		http.NotFound(w, r)
	}
}
...
func (a *API) handleDCSLogsQuery(w http.ResponseWriter, r *http.Request) {
	var qp QueryParams
	if err := qp.DecodeFrom(r.URL, rangeNotRequired); err != nil {
		http.Error(w, err.Error(), http.StatusBadRequest)
		return
